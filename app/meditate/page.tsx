...
export default function Reset() {
    ...
    return (
        <section className="p-4">
            <h1 className="mb-2 text-2xl font-medium tracking-tight">welcome to meditate</h1>
            <p className="mb-4">
            "Unlock Your Inner Zen: How Meditation Can Help You Debug Your Mind (And Your Code." ~ ChatGPT
            </p>
                ...
                <div className=" p-3 w-fit flex flex-col md:flex-row">
                    <div className="group relative justify-center items-center">
                        <img
                            ...
                            className="w-full md:w-36 block rounded"
