...
export const projects: Project[] = [
  
  {
    ...
    year: 2025,
    description:
      "I built ReadySetShoot, a photography planning app's website that combines sunrise/sunset times, astro forecasts, and tides into one platform. Developed with React and Tailwind CSS, it delivers an intuitive, polished experience for photographers.",
